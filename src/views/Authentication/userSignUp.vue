<template>
  <div class="container w-3/4 mx-auto">
    <form
      ...
      class="absolute p-4 w-full max-w-6xl right-1/2 top-1/2 translate-x-1/2 -translate-y-1/2 bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700"
    >
